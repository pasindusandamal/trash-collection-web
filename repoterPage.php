...
<body>
    ...
    <form action="repoterInfo.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <table>
                    <tr>
                        ...
                        <th> <label for="nearest-city">Nearest City Name:</label></th>
        ...
        <button class="btn btn-primary rounded-0 " type="button" onclick="showMap()">Select Location</button> &nbsp &nbsp <button class="btn btn-primary rounded-0 " type="submit">Submit Report</button>
